...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='ingenuity.conf'
CONFIGFOLDER='/root/.ingenuity'
COIN_DAEMON='ingenuityd'
COIN_CLI='ingenuity-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/IngenuityCoin/Ingenuity/files/2548062/Ingenuity-Daemon-.Ubuntu_16.04.tar.gz'
...
function download_node() {
  ...
  wget -q $COIN_TGZ
  tar xzvf Ingenuity-Daemon-.Ubuntu_16.04.tar.gz
  cd rev >/dev/null 2>&1
...
addnode=104.248.113.141
addnode=104.248.121.23
addnode=138.197.217.53
addnode=206.189.11.138
addnode=128.199.203.87
addnode=178.62.77.53
addnode=104.248.33.190
